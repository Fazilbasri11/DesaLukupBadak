...
<body id="home" class="scrollspy">
  ...
  <div class="slider">
    <ul class="slides">
      <li>
        <img src="<?php echo base_url('assets') ?>/user/img/slider/lambo.jpg"> <!-- random image -->
        <div class="caption center-align">
          <h3 style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">Selamat Datang di Portal <br> Desa SP. Lukup Badak</h3>
          <h5 class="light grey-text text-lighten-3">KECAMATAN BIES - KABUPATEN ACEH TENGAH</h5>
        </div>
      </li>
    </ul>
  </div>
  ...
  <section id="fasilitas" class="blue services gray lighten-3 scrollspy">
    <div class="container">
      <div class="row">
        <div class="clients">
          <h3 style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" class="light center grey-text white-text">Fasilitas Desa</h3>
        </div>
        <?php foreach ($fasilitas as $row) { ?>
          <div class="col m6 s12">
            <div class="card-panel center">
              <img src="<?php echo base_url('assets/user/img/portfolio/' . $row->gambar) ?>" class="responsive-img materialboxed">
  ...
  <footer class="blue darken-3 white-text center">
    <p style="font-size: 15px;" class="flow-text">copyright Sp. Lukup Badak <?php echo date('Y'); ?></p>
  </footer>
